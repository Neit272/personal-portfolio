...
export const skills = {
  technical: [
    ...
    { name: "Vite", category: "Framework/Library" },
    { name: "Tailwind CSS", category: "Framework/Library" },
    { name: "Shadcn UI", category: "Framework/Library" },
    ...
    { name: "Networking (TCP/IP, Routing, Firewall)", category: "Knowledge" },
    { name: "Security (Penetration Testing, Malware)", category: "Knowledge" },
  ],
  soft: [
    "Problem Solving",
    "Self-learning",
